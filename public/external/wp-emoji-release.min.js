...
var twemoji = function () {
  ...
  var m = {
      ...
      parse: function (d, u) {
        ...
        return m.doNotParse = u.doNotParse, ("string" == typeof d ? function (d, a) {
          ...
          var f, c, e, b, a, t, r, n, o, i, s, l = function d(u, f) {
            ...
            for (; a--;) c = b[a], 3 === (e = c.nodeType) ? f.push(c) : 1 !== e || "ownerSVGElement" in c || g.test(c.nodeName.toLowerCase()) || m.doNotParse && m.doNotParse(c) || d(c, f);
            return f
          }(d, []), p = l.length;
          for (; p--;) {
            for (e = !1, b = document.createDocumentFragment(), a = l[p], t = a.nodeValue, r = 0; o = h.exec(t);) {
              if ((s = o.index) !== r && b.appendChild(x(t.slice(r, s), !0)), o = o[0], i = N(o), r = s + o.length, s = u.callback(i, u), i && s) {
                for (c in (n = new Image).onerror = u.onerror, n.setAttribute("draggable", "false"), f = u.attributes(o, i)) f.hasOwnProperty(c) && 0 !== c.indexOf("on") && !n.hasAttribute(c) && n.setAttribute(c, f[c]);
                n.className = u.className, n.alt = o, n.src = s, e = !0, b.appendChild(n)
              }
    ...
    f = /\uFE0F/g, c = String.fromCharCode(8205), t = /[&<>'"]/g,
    g = /^(?:iframe|noframes|noscript|script|select|style|textarea)$/, e = String.fromCharCode;
  return m;
