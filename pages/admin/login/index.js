          ...
          <div style={{
            ...
            <div className="w-full surface-card py-8 px-5 sm:px-8" style={{borderRadius: '53px'}}>
              <div className="text-center mb-5">
                <img src="https://nails.shoedog.vn/public/images/Nails%20or%20Never-01%20(1).png" alt="Image"
              ...
              <div>
                ...
                <InputText inputid="email1" type="text" placeholder="Enter user name" className="w-full md:w-30rem mb-5"
                           style={{padding: '1rem'}} value={userName} onChange={(e) => setUserName(e.target.value)}/>
                ...
                <div className="flex align-items-center justify-content-between mb-5 gap-5">
                  <div className="flex align-items-center">
                    <Checkbox inputid="rememberme1" checked={checked} onChange={(e) => setChecked(e.checked)}
