...
const SuccessBookPage = (props : any) => {
    ...
    // const name = props.router.query.name == undefined ? '' : props.router.query.name
    return (
        <>
            <Head>
                <meta charSet="utf-8"/>
                ...
                <title>Booking Success - {process.env.NEXT_PUBLIC_NAME_PRODUCT} - Malta</title>
                ...
                <div className="container-lg">
                    <div className="row">
                        <div className="col-lg-12">
                            <h1 className="text-center mb-0">Booking Success</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container-lg">
                    <div className="row justify-content-center align-items-center gy-5 gx-3 g-lg-5">
                        ...
                        <div className="col-lg-6">
                            <h3 className="sub-title fs-80">Thank you for your booking, {name}!</h3>
                            ...
                            <div className="button-group" style={{display :"flex", justifyContent:"center"}}>
                                <Link href={process.env.NEXT_PUBLIC_HOME_ROUTER as string} replace aria-label="Return to home page">
...
SuccessBookPage.Layout = MainLayout
